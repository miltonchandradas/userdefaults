		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "User Defaults Application",
									"targetURL": "#myuserdefaults-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"myuserdefaults-display": {
								"semanticObject": "myuserdefaults",
								"action": "display",
								"description": "User Defaults Application",
								"title": "User Defaults Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=myuserdefaults",
									"url": sap.ui.require.toUrl("myuserdefaults")
								}
							}
						}
					}
